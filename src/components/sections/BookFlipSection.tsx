...
const BOOK_PAGES: PageData[] = [
  {
    ...
    subtitle: 'Thôn Chánh Oai, Xã Cát Tiến, Tỉnh Gia Lai (Cội nguồn: Cát Hải, Phù Cát, Bình Định)',
    image: '/images/moment-01.jpg',
    badge: 'QUÊ HƯƠNG & CỘI NGUỒN',
    badgeColor: '#00D2FF',
    content: [
      ...
      'Miền đất đong đầy ký ức tuổi thơ, nơi bờ biển bao la và ngọn gió miền duyên hải đã nuôi dưỡng ý chí kiên định, đam mê công nghệ và khát vọng tạo ra những giá trị số thực thụ.',
    ],
    quote: 'Từ cội nguồn Thôn Chánh Oai vững bước vươn ra thế giới công nghệ số.',
    stats: [
      { label: 'Cội nguồn', value: 'Bình Định' },
      { label: 'Hiện tại', value: 'Gia Lai' },
    ],
  },
  {
    id: 'page-2',

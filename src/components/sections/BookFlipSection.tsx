...
const BOOK_PAGES: PageData[] = [
  {
    ...
    subtitle: 'Chánh Oai, Cát Tiến (nguồn cội Chánh Oai, Cát Hải, Phù Cát, Bình Định)',
    image: '/images/moment-01.jpg',
    badge: 'QUÊ HƯƠNG',
    badgeColor: '#00D2FF',
    content: [
      'Sinh ra và lớn lên tại Chánh Oai (Cát Tiến) — vùng đất trước đây thuộc Chánh Oai, Cát Hải, Phù Cát, Bình Định với bờ biển bao la và những đồi cát lộng gió.',
      'Sự kiên định của ngọn gió miền duyên hải và nguồn cội quê nhà là điểm tựa vững chắc nuôi dưỡng đam mê công nghệ và xây dựng những giá trị số.',
    ],
    quote: 'Từ miền đất Chánh Oai nuôi dưỡng ý chí kiên định không ngừng vươn xa.',
    stats: [
      { label: 'Nơi sinh', value: 'Chánh Oai' },
      { label: 'Quê hương', value: 'Cát Tiến' },
    ],
  },
  {
    id: 'page-2',
